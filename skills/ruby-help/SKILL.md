...
- Working on Ruby development tasks
- Needing guidance, best practices, or checklists for Ruby code
- Writing metaprogramming or DSLs
- Optimizing Ruby performance
- Questions about Ruby syntax, idioms, or patterns

## Do not use this skill when

- The task is unrelated to Ruby development
- You need framework-specific Rails guidance (use rails-help instead)
